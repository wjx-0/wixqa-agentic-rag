    ...
    *,
    ...
    system_prompt = "\n".join(
        [
            ...
            "If the evidence enables a correct and actionable answer, set sufficient=true even if some detail, edge case, or caveat is missing.",
            "When in doubt, prefer sufficient=true over triggering unnecessary retrieval.",
            "Before deciding sufficient, decompose the question into explicitly required facets: Wix product, object/entity, feature, action, setting, integration, error, condition, comparison, or required step.",
            "If the question explicitly asks about multiple objects, actions, steps, conditions, products, integrations, or feature requirements, the visible evidence must directly cover every explicitly required facet.",
